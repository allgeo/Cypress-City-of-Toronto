        ...
        <div class="register-content">
          ...
          <?php
              ...
              <div class="inner-reg-2">
                ...
                <form class="" action="confirmNotifiDelete.php" method="post" style="float: right; margin-right: 50px; margin-top: -5px">
                  <h3>Report Resovled:
                  <button type="submit" name="delButton" id="delButton" value=<?php echo "$report[0]"; ?>>Notify & Delete</button>  
                  </h3>
                </form>
